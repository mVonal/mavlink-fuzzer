...
// Mutation aciklamasini yakalamak icin global buffer.
// mutate_packet_random() cagrildiginda, uygulanan mutation'in
// aciklamasini buraya yazar -- logger bunu okur.
char g_last_mutation_desc[256];

int main() {
    srand(time(NULL));

    // SITL'den yakalanmis gercek HEARTBEAT seed paketi
    uint8_t seed_packet[] = {
    ...
    int fuzz_count = 50;  // logger ile 50'ye cikardik
    int total_failed = 0;
    ...
    // Once orijinal paketi gonder -- baglanti dogrulama
